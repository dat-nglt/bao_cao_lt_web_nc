...
const requestBook = async (req, res) => {
    try {
        ...
        const createBorrow = await borrowModel.create({ dueDate, status: 1, bookId: book, userId: user });
...
export default { getAllBooks, getBookById, getBooksByCategory, requestBook};