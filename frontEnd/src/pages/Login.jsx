    ...
    >
      ...
      <Stack minWidth={'450px'} position={'relative'} >
        ...
        <Stack position={'absolute'} p={'10px'} bottom={0} left={0} right={0} bgcolor={theme.palette.primary.main} alignItems={'center'}>
          <Typography sx={{ color: theme.text.primary.main, fontWeight: '600' }} variant='subtitle1'>Đại Học Kỹ Thuật - Công Nghệ Cần Thơ</Typography>
          <Typography sx={{ color: theme.text.primary.main }} variant='caption'>Địa chỉ: 256 Nguyễn Văn Cừ, Quận Ninh Kiều, Thành phố Cần Thơ</Typography>
